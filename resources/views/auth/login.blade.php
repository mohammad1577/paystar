...
<div class="flex min-h-screen justify-center items-center">
    <div class="w-full max-w-md">
        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="{{ route('login') }}">
            ...
            <a class="inline-block align-baseline font-bold text-sm transform transition-all duration-300 ease-in-out text-blue-500 hover:text-blue-800" href="{{ route('registerView') }}">
                Don't have account?
            </a>
            </div>
        </form>
